...
function addUser($db, $username, $password, $fname, $lname, $address, $city, $state, $zip, $phone)
{
    $query = "INSERT INTO customer (username, password, first_name, last_name, street_address, city, user_state, zip, phone)
                VALUES (:username, :password, :fname, :lname, :address, :city, :state, :zip, :phone)";
    $statement = $db->prepare($query);
    $statement->bindValue(':username', $username);
